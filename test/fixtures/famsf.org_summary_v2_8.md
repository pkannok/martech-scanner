...
- Target: https://famsf.org
- Generated at: 2026-03-19T19:23:24.714Z
- Pages scanned: 6
- Failed pages: 0
- Vendors detected: 18
- IDs detected: 8
- Consent interaction: Enabled; interaction captured on 1 of 6 page(s).
...
- **Pinterest Tag** (media_pixel) via network - evidence type: Network evidence (observed firing) - confidence: high (95%)
- **Pinterest Tag** (media_pixel) via script - evidence type: Script evidence (present in source) - confidence: high (85%)
...
- **Shopify** (ecommerce) via network - evidence type: Network evidence (observed firing) - confidence: high (95%)
- **TikTok Pixel** (media_pixel) via network - evidence type: Network evidence (observed firing) - confidence: high (95%)
- **Shopify** (ecommerce) via script - evidence type: Script evidence (present in source) - confidence: high (85%)
- **Google Ads / DoubleClick** (media_pixel) via script - evidence type: Script evidence (present in source) - confidence: high (85%)

## IDs found

- **GTM Container ID:** `GTM-KF3V7ZD` - evidence type: Network evidence, Script evidence, Source evidence, Iframe / noscript evidence
- **GA4 Measurement ID:** `G-XD8ZY7FJG6` - evidence type: Network evidence, Script evidence, Source evidence
- **Google Ads ID:** `AW-661513348` - evidence type: Network evidence
- **UA Property ID:** `UA-936475-3` - evidence type: Network evidence
- **Pinterest Tag ID:** `2613646378106` - evidence type: Network evidence
- **Facebook Pixel ID:** `1888698` - evidence type: Script evidence, Source evidence
- **Facebook Pixel ID:** `1809781` - evidence type: Script evidence, Source evidence
- **Facebook Pixel ID:** `1809799` - evidence type: Script evidence, Source evidence
...
- Status: ok
- HTTP status: 200
- Title: Fine Arts Museums of San Francisco | de Young and Legion of Honor
- Network findings: 27
- Third-party scripts: 11
- Cookies captured: 12
- Globals present: dataLayer
- Google source signals: google_tag_manager, dataLayer
- Source-derived IDs: 7
  - GTM Container ID: GTM-KF3V7ZD (Iframe / noscript evidence)
  - GA4 Measurement ID: G-XD8ZY7FJG6 (Source evidence)
  - Facebook Pixel ID: 1888698 (Source evidence)
  - Facebook Pixel ID: 1809781 (Source evidence)
  - Facebook Pixel ID: 1809799 (Source evidence)
...
- Status: ok
- HTTP status: 200
- Title: de Young & Legion of Honor Museum Stores
- Consent clicks: continue; continue shopping
- Network findings: 102
- Third-party scripts: 12
- Cookies captured: 16
- Globals present: dataLayer
- Google source signals: google_tag_manager, gtag, dataLayer
- Source-derived IDs: 2
  - GA4 Measurement ID: G-XD8ZY7FJG6 (Source evidence)
...
- Confirm whether consent state changes vendor firing; consent interaction was captured on 1 page(s) in this scan.
- Review failed, blocked, timeout, HTTP-error, or thin pages (4 failed/partial; 4 thin/low-evidence).
